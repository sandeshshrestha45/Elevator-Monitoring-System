...
def process_videostream(detector, sound_player, db):
    picam2 = Picamera2()
    ...
    try:
        while True:
            ...
            if detection_start_time and not ocr_sent:
                if time.time() - detection_start_time >= 0.1 and sharpest_image is not None:
...
def main():
    detector = ObjectDetector(
        weights="/home/elevatorpi4/project/EMS-phase2-deploy/models/yolov4_det_250401.weights",
    ...
    db = OCRDatabase()
    process_videostream(detector, sound_player, db)
